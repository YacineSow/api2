...
// Returns the private 'App\Repository\AdminwariRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdminwariRepository.php';

return $this->privates['App\\Repository\\AdminwariRepository'] = new \App\Repository\AdminwariRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
